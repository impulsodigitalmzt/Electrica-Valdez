    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-[640px] gap-0 overflow-hidden rounded-[28px] border-0 p-0 shadow-2xl sm:rounded-[28px]">
        ...
        {!preview ? (
          ...
          >
            <span className="flex size-16 items-center justify-center rounded-full bg-background text-black shadow-sm">
            ...
            <button
              type="button"
              className="mt-2 inline-flex items-center gap-2 text-sm font-medium text-black hover:underline"
          ...
          <div className="px-6 pb-6">
            ...
            {!leyendo ? (
              <button
                type="button"
                className="mt-3 inline-flex items-center gap-2 text-sm font-medium text-black hover:underline"
                onClick={() => {
                  setPreview("");
                  setConsulta("");
                  setProductos([]);
