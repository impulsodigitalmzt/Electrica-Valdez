      ...
      [
        {
          role: "system",
          content:
            'Eres el router invisible del mostrador de Eléctrica Valdez. Responde SOLO JSON: {"ruta":"producto"|"proyecto"|"cuenta"}. producto = un artículo concreto. proyecto = armado o lista de materiales. cuenta = total, carrito o cierre. Si dudas, producto.',
        },
